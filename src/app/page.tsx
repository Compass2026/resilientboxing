                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 relative z-10">
                      ...
                      <div className="md:col-span-7 flex flex-col justify-between">
                        <div>
                          ...
                          {/* Bullet points with boxing glove icons */}
                          <ul className="space-y-4 mb-8">
                            {CLASSES[activeClass].highlights.map((hl, i) => (
                              <li key={i} className="flex items-start gap-3">
                                <span className="text-[#C5A059] shrink-0 mt-0.5">
                                  <BoxingGloveIcon className="w-5 h-5" />
                                </span>
                                <div>
                                  <span className="text-white font-bold uppercase tracking-wider text-[11px] block mb-0.5">
                                    {hl.title}
                                  </span>
          ...
          <GlassPanel className="overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[580px]">
              ...
              <div className="relative min-h-[320px] overflow-hidden">
                <Image
                  src="/faith-gloves-cross-massive.png"
                  alt="Faith Over Fear"
                  fill
                ...
                <div className="absolute bottom-6 left-6">
                  <div className="glass-heavy rounded-xl px-4 py-2.5 border border-white/10">
                    <p className="text-[9px] font-mono uppercase tracking-[0.3em] text-zinc-200">Faith Over Fear</p>
              ...
              <div className="relative flex flex-col justify-center px-8 md:px-12 py-12">
                <div className="absolute inset-0 glow-silver opacity-25 pointer-events-none" />
                <div className="relative z-10">
                  ...
                  <blockquote className="text-base md:text-lg font-light text-white/90 leading-relaxed italic border-l-2 border-zinc-400/50 pl-5 mb-8">
        ...
        <div className="max-w-[1400px] mx-auto px-5 md:px-10">
          ...
          <div className="mt-12 glass-heavy rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 border border-white/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-zinc-400 text-sm font-light mt-2">No agreement. No commitment. Just show up.</p>
            </div>
