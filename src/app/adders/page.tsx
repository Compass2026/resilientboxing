    ...
    items: [
      {
        ...
        type: "Modules",
        model: "Phono 420-440",
        fullTitle: "Phono Solar Draco PS440M8GF-18/VNHB 440W",
        manufacturer: "Phono Solar",
        specSheetName: "Phono Solar Draco Series N-TOPCon Mono 420-440W Datasheet",
        specSheetUrl: "https://us.phonosolar.com",
        badge: "N-TOPCon All-Black",
        specsSummary: {
          powerOutput: "420 - 440 Watt (STC)",
          efficiency: "22.53% Max Module Efficiency",
          warranty: "15-Yr Product / 30-Yr Linear (0.4% annual)",
          technology: "N-TOPCon High Efficiency Mono Dual Glass (Bifacial >80%)",
          dimensions: "1722 × 1134 × 30 mm (24.0 kg)",
          certifications: "BloombergNEF Tier 1, PVEL Top Performer 2023, IEC 61215/61730, UL 61730",
        },
      },
      {
        id: "iq8mc_std",
                        ...
                        <div key={spec.id} className="bg-white p-3.5 rounded-xl border border-slate-200/80 shadow-2xs hover:border-slate-300 transition-colors">
                          ...
                          <div className="flex items-end justify-between gap-2">
                            ...
                            <button
                              ...
                              className="inline-flex items-center justify-center gap-1.5 h-8 px-4 rounded-full bg-[#0F232A] text-white hover:bg-[#FACC15] hover:text-black transition-all text-xs font-bold shrink-0 whitespace-nowrap shadow-sm cursor-pointer"
                            >
                              <FileText size={12} />
