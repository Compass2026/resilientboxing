...
export default function FaithOverFearClassPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "You will need hand wraps and boxing gloves. We do not charge for your first class if you have your own equipment. If you need equipment, you can rent or buy from us (hand wraps are $14.99 and glove rental is $4.99).",
    },
    {
  ...
  return (
    <div className="noise bg-[#080808] min-h-screen text-white relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] glow-purple opacity-40 rounded-full blur-3xl" />
        ...
        <div className="max-w-[1400px] mx-auto px-5 md:px-10 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <Link
                href="/"
                className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-zinc-300 mb-6 hover:text-white transition-colors"
              >
                <ArrowLeft size={12} /> Back to Homepage
              </Link>
              <p className="text-[10px] font-mono uppercase tracking-[0.45em] text-zinc-400 mb-4">
            ...
            <div className="lg:col-span-5 w-full">
              <div className="glass-heavy rounded-2xl border border-white/10 p-6 md:p-8 shadow-2xl shadow-black/70 relative">
                <div className="absolute top-0 right-0 w-48 h-48 glow-purple opacity-20 rounded-full pointer-events-none" />
                    ...
                    <div key={idx} className="flex justify-between items-center py-2 border-b border-white/5 last:border-0">
                      ...
                      <div className="flex gap-2">
                        {sched.times.map((t, tIdx) => (
                          <span key={tIdx} className="glass-purple text-[9px] font-mono uppercase tracking-widest text-zinc-100 px-2.5 py-1 rounded-md border border-white/20 shadow-[0_0_12px_rgba(255,255,255,0.1)]">
                            {t}
                          </span>
                        ))}
                      </div>
                ...
                <div className="glass rounded-xl p-4 border border-white/6 mb-6">
                  <div className="flex items-start gap-3">
                    <Check size={16} className="text-zinc-200 shrink-0 mt-0.5" />
                ...
                <button
                  ...
                  className="w-full py-4.5 bg-gradient-to-r from-zinc-100 via-zinc-300 to-zinc-400 hover:from-white hover:to-zinc-200 text-black text-xs font-bold uppercase tracking-widest rounded-xl transition-all duration-300 shadow-xl shadow-black/40 cursor-pointer flex items-center justify-center gap-2"
                >
      ...
      <section className="relative z-10 py-16">
        <div className="max-w-[1400px] mx-auto px-5 md:px-10">
          <div className="glass-purple rounded-2xl p-8 md:p-12 relative overflow-hidden text-center max-w-4xl mx-auto border border-white/20 shadow-xl shadow-black/30">
            <div className="absolute top-0 left-0 w-full h-full glow-purple opacity-20 pointer-events-none" />
            <span className="text-zinc-100 inline-block mb-4">
              <Sparkles size={24} />
            </span>
            <blockquote className="text-xl md:text-2xl font-light text-white leading-relaxed italic mb-5">
              "{cls.scripture.text}"
            </blockquote>
            <cite className="block text-[10px] font-mono not-italic uppercase tracking-[0.3em] text-zinc-400">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="glass-card rounded-2xl p-6 border border-white/8">
                <div className="flex justify-between text-[10px] font-mono uppercase tracking-widest text-zinc-400 mb-3">
                  ...
                  <span className="text-zinc-100 font-bold">{cls.intensity}%</span>
                </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className={`text-zinc-400 transition-transform duration-300 ${active ? "rotate-45" : ""}`}>
                      +
                    </span>
                  </button>
                  <motion.div
