...
export default function FightCampClassPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "You must bring 16oz sparring-specific gloves (standard bag gloves are not permitted), a fitted mouthguard, and a groin protector. Headgear is highly recommended.",
    },
    {
      q: "What does a session look like?",
      a: "Sessions are 90 minutes. We start with technical ring positioning, followed by coach-led mitt work or partner slip-drills. The second half of the class involves controlled sparring, situational work (corner escapes, ropes defense), and finishes with advanced aerobic conditioning.",
    },
  ];
      ...
      <section className="relative h-[65vh] min-h-[500px] flex items-center justify-center overflow-hidden z-10 pt-20">
        ...
        <div className="max-w-[1400px] mx-auto px-5 md:px-10 relative z-10 w-full flex flex-col justify-end h-full pb-16">
          <div className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-950/40 border border-red-500/30 rounded-full mb-4">
              <ShieldAlert size={12} className="text-red-400" />
              <span className="text-[8px] font-mono uppercase tracking-wider text-red-300">Invite Only Class</span>
            </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: "Skill Level", val: "Advanced (Invite Only)" },
            ...
            <div className="lg:col-span-5">
              <div className="glass-heavy rounded-2xl border border-white/10 p-6 md:p-8 shadow-2xl shadow-black/70 relative">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    { day: "Saturday", times: ["8:00 AM (90 mins)"], note: "Invite Only" },
                  ].map((sched, idx) => (
                    <div key={idx} className="flex justify-between items-center py-2 border-b border-white/5 last:border-0">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        ...
                        {sched.note && (
                          <span className="text-[8px] font-mono text-red-400 uppercase tracking-widest mt-0.5">
                            {sched.note}
                          </span>
                        )}
                      </div>
                ...
                <div className="glass rounded-xl p-4 border border-white/6 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-xs text-zinc-400 font-light leading-relaxed">
                      Participation is contingent on coach safety clearance. Talk to a coach to request an invite.
                    </p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-4.5 bg-red-600 hover:bg-white hover:text-black text-white text-xs font-bold uppercase tracking-widest rounded-xl transition-all duration-300 shadow-xl shadow-black/40 cursor-pointer flex items-center justify-center gap-2 border border-red-500/20"
                >
                  Request Invite <MoveRight size={13} />
                </button>
              </div>
            </div>
