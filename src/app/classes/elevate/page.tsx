  ...
  const faqs = [
    {
      ...
      a: "Yes, 100%. Elevate 60 is built so that anyone can participate. Our coaches break down every single punch combination, defensive movement, and footwork mechanic from square one.",
    },
    {
      q: "Do I need to bring my own gloves and wraps?",
      a: "For your first session, we provide boxing gloves for free. We do require hand wraps to protect your knuckles and wrists, which are available for purchase at the front desk for $10.",
    },
    {
  ...
  return (
    <div className="noise bg-[#080808] min-h-screen text-white relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[40%] right-[-10%] w-[500px] h-[500px] glow-gold opacity-30 rounded-full blur-3xl" />
      </div>
              ...
              <div className="glass-heavy rounded-2xl border border-white/10 p-6 md:p-8 shadow-2xl shadow-black/80 relative">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    { day: "Friday", times: ["5:30 AM", "6:00 PM"] },
                  ].map((sched, idx) => (
